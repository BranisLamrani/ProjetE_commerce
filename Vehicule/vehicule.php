...
if(isset($_POST['matricule'])&& isset($_POST['marque']) && isset($_POST['modele'])&&
    ...
    $modele=$_POST['modele'];
    $prix=$_POST['prix'];
    $requete= $dbh->prepare('INSERT INTO vehicule(matricule,marque,modele,prixheure,image) VALUES(:matricule,:marque,:modele,:prix,:image)');
...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        <form class="ui form" method="post" action="vehicule.php" enctype="multipart/form-data">
            <div class="field">
...
<script>
    var view = document.getElementById("viewPic");
    document.write(view);
</script>
<script
